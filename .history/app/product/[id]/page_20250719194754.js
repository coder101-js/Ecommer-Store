      ...
      <div className="grid md:grid-cols-2 gap-16">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2 overflow-x-auto">
            {product.images.map((src, i) => (
              <div key={i} className="w-20 h-20 relative flex-shrink-0">
                <Image
                  src={src}
                  alt={`Image ${i + 1}`}
                  fill
                  className="object-cover rounded-md border dark:border-neutral-700"
                />
              </div>
            ))}
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
            ...
            <p><strong>Dimensions:</strong> {product.dimensions.width}W x {product.dimensions.height}H x {product.dimensions.depth}D</p>
          ...
          <button className="mt-4 px-6 py-3 bg-black text-white rounded-full hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-gray-300 transition">
            Add to Cart
          </button>
