...
import {clearCart} from "../context/CartContext"; // 🛒 clear cart after success
...
export default async function SuccessPage() {
  ...
  const fullUrl = new URL(headersList.get("x-next-url"), "https://your-ecom.com");
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-center">
      ...
      <p className="mt-4 text-lg">
        Thank you for your purchase, {payload.name || "customer"}! Your order is confirmed.
      </p>
