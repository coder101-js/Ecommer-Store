            ...
            >
              ...
              >
                <Image
                  ...
                  width={400}
                  height={400}
                  className="w-3/4 h-auto object-contain transform skew-y-6 rotate-[-6deg] group-hover:skew-y-0 group-hover:rotate-0 group-hover:scale-110 transition-all duration-500 ease-in-out"
                />
              </div>
