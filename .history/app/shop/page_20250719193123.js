      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          ...
          <input
            ...
            className="ml-4 px-4 py-2 rounded-full border bg-gray-100 dark:bg-neutral-900 text-black dark:text-white focus:outline-none"
          />
        </div>
...
function HoverImageCard({ product }) {
  ...
  return (
    <div
      className="bg-white dark:bg-[#1f2937] rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300 group hidden"
