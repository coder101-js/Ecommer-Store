...
colors = ["Red", "Black", "White", "Blue", "Green", "Grey", "Orange"]
...
def generate_shoe():
    ...
    product = {
        ...
        "colors": [
            {
                "color": color,
                "image": f"https://fakeimg.pl/400x400/{color.lower()}/ffffff?text={quote(f'{brand} {model} {color}')}"
            }
...
# Save to a JSON file
file_path = "/mnt/data/fake_shoes_fixed.json"
