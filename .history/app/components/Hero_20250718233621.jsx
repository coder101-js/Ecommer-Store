...
export default function Hero() {
  ...
  return (
    <section
      ...
      text-black dark:text-white px-4 md:px-12
      transition-colors duration-500"
    >
      <div className="max-w-7xl mx-auto h-full flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
        {/* Text Content */}
        ...
        <div className="flex-1 flex flex-col items-center">
          ...
          >
            <div className="w-[250px] sm:w-[280px] md:w-[350px] max-w-full">
              <Image
                src={active.image}
