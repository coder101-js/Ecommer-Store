...
export default function Hero() {
  ...
  return (
    <section className="w-full bg-white dark:bg-black text-black dark:text-white pt-16 pb-32 px-4 md:px-12 transition-colors duration-300">
          ...
          >
            <div className="w-[280px] sm:w-[300px] md:w-[350px] max-w-full">
              <Image
                ...
                width={500} // doesn't matter with responsive sizing
                height={500}
            ...
            {shoes.map((shoe, i) => (
              <button
                ...
                className={`w-6 h-6 rounded-full border-2 transition-all ${
                  activeIndex === i
                    ? "border-black dark:border-yellow scale-110"
                    : "border-transparent"
                }`}
