...
const shoes = [
  {
    color: 'blue',
    hex: '#3B82F6',
    image: '/shoes/bolt-blue.png',
  },
  {
    color: 'red',
    hex: '#EF4444',
    image: '/shoes/bolt-red.png',
  },
  {
    color: 'green',
    hex: '#22C55E',
    image: '/shoes/bolt-green.png',
  },
]
    ...
    <section className="w-full bg-white dark:bg-black text-black dark:text-white pt-16 pb-32 px-4 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 space-y-6">
          <p className="text-lg font-medium text-gray-500 dark:text-gray-400">Engineered for Speed</p>
          <h1 className="text-4xl md:text-6xl font-bold leading-tight">
            Bolt Into the Future<br />
            with <span className="text-white-500">BoltForm</span>
          </h1>
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <button className="text-blue-500 font-medium hover:underline">Explore Collection</button>
          </div>
        </div>
        ...
        <div className="flex-1 relative">
          ...
          <div className="flex gap-3 justify-center mt-6">
            {shoes.map((shoe) => (
              <button
                key={shoe.color}
                className={`w-6 h-6 rounded-full border-2 ${active.color === shoe.color ? 'border-black dark:border-white' : 'border-transparent'}`}
