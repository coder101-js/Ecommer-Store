...
export default function Navbar() {
  ...
  const [cartCount, setCartCount] = useState(69);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              href="/auth"
              className="flex items-center gap-2 text-sm px-3 py-1 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition"
            >
            ...
            {mounted ? (
              ...
              // 🧩 Placeholder with same size as button
              <div className="p-2 rounded-full bg-transparent w-[37px] h-[38px]" />
            )}
          </div>
        </div>
      </div>
