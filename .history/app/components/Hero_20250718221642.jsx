<section
  className="w-full 
  bg-gradient-to-b from-[#fefcea] via-[#f1f2b5] to-[#d4fc79]
...
>
  <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-12">
    <div className="flex-1 space-y-6 text-center md:text-left">
      <p className="text-lg font-medium text-gray-700 dark:text-gray-400 tracking-wide">
        Engineered for Speed
      </p>
      <h1 className="text-4xl md:text-6xl font-extrabold leading-tight bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 bg-clip-text text-transparent dark:text-white">
        Bolt Into the Future
        <br />
        with <span className="text-black dark:text-yellow-400">BoltForm</span>
      </h1>
