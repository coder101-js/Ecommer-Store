...
export default function Navbar() {
  ...
  return (
    <>
      <motion.nav
        style={{ height }}
        className="fixed top-0 left-0 w-full z-50 bg-grey-600 dark:bg-gray-900 border-b border-gray-200 dark:border-neutral-800 backdrop-blur transition-colors mb-4"
      >
