...
export default function Navbar() {
  ...
  useEffect(() => {
    setMounted(true);
    setNavLinks(["Shop", "New Arrivals", "shop?category=mens-shoes", "shop?category=womens-shoes", "Sale"]);
    setCartCount(3);
  }, []);
            ...
            {pathName === "/shop" && (
              ...
              >
                <input
                  ...
                  className="text-sm px-4 py-1.5 rounded-full border bg-gray-100 dark:bg-neutral-900 text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white transition w-full"
                  value={searchQuery}
