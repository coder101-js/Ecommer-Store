      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <Link
              href="/shop"
              className="hover:underline text-gray-700 dark:text-gray-300 transition-colors"
            >
              Shop
            </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/cart" className="relative">
              ...
              {cartCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-red-500 text-white rounded-full text-xs w-5 h-5 flex items-center justify-center animate-ping">
                  {cartCount}
                </span>
              )}
            </Link>
