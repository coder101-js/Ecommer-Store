        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:space-x-4 justify-end">
            ...
            <motion.div whileHover={{ scale: 1.05 }}>
              <Link
                href="/auth"
                className="px-3 py-1 text-xs sm:text-sm rounded-full font-semibold bg-blue-700 text-white hover:bg-blue-800 dark:bg-white dark:text-black dark:hover:bg-gray-100 transition"
              >
                Sign In
              </Link>
            </motion.div>
